...
console.log("El arrary [8,32,53,63,64,86,45] contiene números pares: ")
console.log(pares([8,32,53,63,64,86,45]))

console.log("\n")
console.log("El arrary [345,363,23,461] contiene números pares: ")
console.log(pares([345,363,23,461]))

console.log("\n")
console.log("El arrary [24,435,257,76,355] contiene números pares: ")
console.log(pares([24,435,257,76,355]))